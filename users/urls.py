...
urlpatterns = [
    ...
    path('change-password/', auth_views.PasswordChangeView.as_view(template_name='users/password/password_change_form.html'), name='change-password'),
    ...
    path("edit-form/", views.edit, name="edit"),
